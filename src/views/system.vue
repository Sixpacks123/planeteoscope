<template>
  <div>
    <canvas ref="canvas" />
    <Options @speed-changed="onSpeedChange" />
    <PlanetCard
      v-if="selectedPlanetCard != null"
      :planet-info="selectedPlanetCard"
      @close-card="selectedPlanetCard = null"
    />
    <div
      class="date-display"
      :class="{disabled: idealizedSpeed}"
    >
      <div class="ico">
        <svg
          viewBox="0 0 448 512"
...
export default {
  ...
  methods: {
    ...
    createCamera: function () {
      return new THREE.PerspectiveCamera(47, window.innerWidth / window.innerHeight, 0.1, 1000)
    },
