      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Notre application PlanétoScope est conçue pour les passionnés d'astronomie.
          </h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">
            PlanétoScope offre une expérience immersive pour explorer le système solaire. Découvrez les astres avec des filtres de recherche et des informations détaillées, enregistrez vos favoris et découvrez chaque jour une nouvelle image spectaculaire de l'espace.
          </p>
        </div>
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            ...
            <p class="text-gray-500 dark:text-gray-400">
              Découvrez la liste complète des astres et filtrez-les selon vos critères. Obtenez toutes les informations dont vous avez besoin en un clic.
            </p>
          </div>
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p class="text-gray-500 dark:text-gray-400">
              Explorez les astres en profondeur avec toutes les informations détaillées que vous cherchez. Accédez aux lunes d'une planète en un clic.
            </p>
          </div>
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p class="text-gray-500 dark:text-gray-400">
              Visualisez facilement la position des planètes dans notre système solaire grâce à notre représentation graphique. Obtenez toutes les informations détaillées des astres en un clic.
            </p>
          </div>
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p class="text-gray-500 dark:text-gray-400">
              Gérez facilement vos astres préférés en les ajoutant ou les supprimant de votre liste. Recevez des notifications pour chaque nouvel ajout et accédez à votre liste en un clic.
            </p>
          </div>
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <h3 class="mb-2 text-xl font-bold dark:text-white">
              Exploration spatiale virtuelle
            </h3>
            <p class="text-gray-500 dark:text-gray-400">
              Explorez l'espace en réalité virtuelle avec des images en temps réel de la NASA, utilisant votre smartphone et un casque de réalité virtuelle.
            </p>
          </div>
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
